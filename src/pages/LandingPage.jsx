...
//       {/* HERO SECTION */}
//       <section className="flex flex-col items-center justify-center text-centermt-20 md:mt-40 px-4">

//         <h1 className="text-4xl md:text-7xl font-bold text-green-600">
//           Tomato LeafGuard
//         </h1>
...
//         <Link
//       to="/diagnosis"
//        className="mt-10 bg-green-500 text-white px-5 md:px-10 py-3 md:py-4 text-sm md:text-lg hover:bg-green-600 transition inline-block"
//       >
...
// {/* LAYANAN KAMI */}
// <section
//   className="relative min-h-screen bg-cover bg-center flex flex-col items-center justify-center px-4 md:px-10 py-20"
//   style={{
...
//   {/* SUBTITLE */}
//   <p className="text-white text-base md:text-2xl text-center mt-6 max-w-4xl">
...
//     {/* CARD 1 */}
//     <div className="border-4 border-white rounded-[40px] p-8 w-full md:w-[320px] text-white">

//       <Camera size={50} className="mb-6 text-white" />
...
//       <ClipboardCheck size={50} className="mb-6 text-white" />
...
//     {/* CARD 3 */}
//     <div className="border-4 border-white rounded-[40px] p-8 w-full md:w-[320px] text-white hover:scale-105 transition duration-300">
//       <BookOpen size={50} className="mb-6 text-white" />
...
// </section>
// {/* CARA PENGGUNAAN */}
// <section className="bg-[#F3F3F3] py-16 md:py-32 px-4 md:px-20">
...
//       <h1 className="text-3xl md:text-6xl font-bold text-gray-700 mb-20">
//         Cara Penggunaan
//       </h1>
...
// </section>
// {/* FOOTER */}
// <footer className="bg-green-600 text-white py-12 px-4 md:px-20">

//   <div className="flex flex-col md:flex-row justify-between items-centertext-center md:text-left flex-wrap gap-10">
...
">
  ...
  >
    Sign Up
      ...
      {/* HERO SECTION */}
      <section className="flex flex-col items-center justify-center text-center mt-20 md:mt-40 px-4">
...
<footer className="bg-green-600 text-white py-12 px-4 md:px-20">
  ...
  <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left flex-wrap gap-10">
